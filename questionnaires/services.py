...
def ensure_questionnaire_excel():
    ...
    questions = [
        ...
        },
        {
            ...
            "id": "Q-006",
            "category": "原価計算",
            "question_text": "製品別・案件別の原価を把握していますか？",
            "risk_level": "高",
            "recommended_task_name": "製品別・案件別の原価管理表を整備する",
            "recommended_task_category": "原価管理",
            "recommended_owner": "経理部",
            "recommended_due_date": "",
            "related_document_id": "",
        },
        {
            "id": "Q-007",
            "category": "原価計算",
            "question_text": "材料費、外注費、労務費、製造間接費を分けて管理していますか？",
            "risk_level": "高",
            "recommended_task_name": "材料費・外注費・労務費・製造間接費の分類ルールを整備する",
            "recommended_task_category": "原価管理",
            "recommended_owner": "経理部",
            "recommended_due_date": "",
            "related_document_id": "",
        },
        {
            "id": "Q-008",
            "category": "原価計算",
            "question_text": "原価率や粗利率を月次で確認していますか？",
            "risk_level": "高",
            "recommended_task_name": "月次の原価率・粗利率確認ルールを整備する",
            "recommended_task_category": "原価管理",
            "recommended_owner": "経理部",
            "recommended_due_date": "",
            "related_document_id": "",
        },
        {
            "id": "Q-009",
            "category": "原価計算",
            "question_text": "見積原価と実績原価を比較していますか？",
            "risk_level": "中",
            "recommended_task_name": "見積原価と実績原価の比較表を作成する",
            "recommended_task_category": "原価管理",
            "recommended_owner": "製造部",
            "recommended_due_date": "",
            "related_document_id": "",
        },
        {
            "id": "Q-010",
            "category": "原価計算",
            "question_text": "不良、手直し、歩留まりロスを原価に反映していますか？",
            "risk_level": "中",
            "recommended_task_name": "不良・手直し・歩留まりロスの原価影響を確認する",
            "recommended_task_category": "原価管理",
            "recommended_owner": "製造部",
            "recommended_due_date": "",
            "related_document_id": "",
